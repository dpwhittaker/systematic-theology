...
> [!slide]
> **background:** [brief description — Stable Diffusion prompt]
> **text:** [verse reference + text displayed on screen]

![slide](images/section-title-1.png)
...
![slide](images/next-section-1.png)
````
...
- **Image** — `![slide](images/filename.png)` follows each slide callout. Generated by Stable Diffusion from the `background` prompt, with verse text composited on top. This lets us iterate on visuals alongside the script.
