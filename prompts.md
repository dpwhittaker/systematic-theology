...
In the Sinless Mechanism, draw a stronger link between the spirit-made man, a man patterned after pre-fall Adam, his capability of being sinless, and his capacity for the Spirit. The High Priest could die if he entered the Holy of Holies unclean. Looking at the face of God was also fatal. Simply encountering the Shekinah is not something a sinful human could withstand, much less containing it. Jesus had to be different. My personal midrash is that the genetic material Jesus received from the Holy Spirit was a return the template of pre-fall Adam. In any case, the unique human the Holy Spirit made in Mary's womb was a return to the "very good" creation which was able to walk with God in the garden, and broke the chain of the curse passed down through the generations to all of us. The miraculous birth is the only way Jesus could remain sinless, and it's the only way he could be capable of containing the full measure of the Shekinah.
...
Alright, it's time to start working on a Pneumatology handout. As always, let's keep it at a high school level without Bible College experience. And this group comes from a wide variety of traditional and pentecostal backgrounds. So the fundamental questions they are asking are everywhere from "is water baptism and spirit baptism different?" and "is speaking in tongues real?" to "is it required for salvation?" to "What did Paul mean by the 'greater gifts'?" Let's move the focus away from the metaphysics of the previous handouts to a more pastoral "what do we DO with the Holy Spirit?" focus for this handout. As always, start with scripture. What does the scripture say about the Holy Spirit, about how he indwells believers, and does He ever leave? Do we ever need a rebaptism? We will probably refine and focus later, but I honestly don't know where to start, so let's cover everything related and then we will have several editing passes, perhaps splitting into multiple handouts. This just wasn't covered well in my traditional Bible college. Be sure to exercise traditional exegetical values though. Focus on what the text says and what it meant in its historical context, not eisigesis in today's context.
...
Read through the @storyboards/format-spec.md and understand how storyboards are implemented.  Then create a storyboard that represents a 4-person panel discussing the content of @handouts/baptism-in-the-spirit.md. Don't use real people's names, but note that the NT Wright analog (a professor and researcher of biblical studies and archaeology) should have a deep British male voice, the Baptist theologian should sound like a confident woman, the Pentecostal theologian should sound like an educated but passionate man, and the layperson should sound like a 20-something inquisitive woman. Once completed, show me the storyboard in chrome
...
Evaluate that first paragraph (don't make any changes, just answer here). Would any Open Theists be ok with saying that God started evil and became good, or made mistakes in the past but has grown from them?
